...
//    $().getId('box').css('background','pink');
//
//    $().getTagName('p').css('background','lightgreen');
//
//    console.log($().getId('box').html());
//
//    console.log($().getId('box').css('fontSize'));
//
//    console.log($().getClass('red').css('color','red'));
//
//    console.log($().getClass('red').eq(1).css('color','black'));
//
//    console.log($().getClass('red','reg').css('background','#ccc'));
